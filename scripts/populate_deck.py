...
def main():
    ...
    cards = []
    cards += one_form(c, verbs, 'INDICATIVO_PASSATO_PROSSIMO', 1, 0, 50, "A1")
    cards += one_form(c, verbs, 'INDICATIVO_PASSATO_PROSSIMO', 0.5, 51, 250, "A2")
    cards += one_form(c, verbs, 'INDICATIVO_PASSATO_PROSSIMO', 0.25, 251, 500, "B1")
    cards += one_form(c, verbs, 'INDICATIVO_PASSATO_PROSSIMO', 0.25, 501, 1000, "B2")
    ...
    cards += one_form(c, verbs, 'INDICATIVO_TRAPASSATO_PROSSIMO', 0.25, 0, 500, "B1")
    cards += one_form(c, verbs, 'INDICATIVO_TRAPASSATO_PROSSIMO', 0.25, 501, 1000, "B2")
    ...
    cards += one_form(c, verbs, 'CONDIZIONALE_PASSATO', 0.25, 0, 500, "B1")
    cards += one_form(c, verbs, 'CONDIZIONALE_PASSATO', 0.25, 501, 1000, "B2")

    cards += one_form(c, verbs, 'INDICATIVO_PASSATO_REMOTO', 1, 0, 1000, "B2")
    cards += one_form(c, verbs, 'INDICATIVO_TRAPASSATO_REMOTO', 0.25, 0, 1000, "B2")
    cards += one_form(c, verbs, 'INDICATIVO_FUTURO_ANTERIORE', 0.25, 0, 1000, "B2")
